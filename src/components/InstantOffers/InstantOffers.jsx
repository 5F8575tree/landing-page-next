...
const InstantOffers = () => {
  ...
  const handleScroll = () => {
    const imageScrollThreshold = 2900;
    const formScrollThreshold = 3100;
    if (
  ...
  return (
    <div className="relative flex flex-col items-center">
      ...
      />
      <div
        className={`bg-white flex flex-col items-center py-10 px-8 mx-8 absolute top-1/3 left-0 rounded-xl ${
